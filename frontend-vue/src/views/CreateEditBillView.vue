    ...
    <div class="row border-bottom pb-3 mb-3">
      ...
      <div class="col">
        <div class="d-flex justify-content-end gap-2">
          <div class="text-end">
            <router-link to="/bills" class="btn btn-outline-secondary">
              <i class="fa-solid fa-angle-left"/>
              Retour
            </router-link>
          </div>
          <div v-if="!isNewBill" class="text-end">
    ...
    <div class="row">
      ...
      <div class="col-md-8">
        ...
        <div class="panel-body">  
          ...
          <p>
            <span v-if="bill.status"> Payé</span>
            <span v-else="!bill.status"> Non payé</span>
            {{ checkbox }}
          </p>
        </div>
      </div>
...
export default {
  ...
  computed: {
    ...
    ...mapWritableState(useClientStore, ['clients']),
